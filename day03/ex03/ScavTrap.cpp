...
{
	std::cout << target << ", which chair would u like to sit on with piki tochonie or hui drochonie ?"
	<< std::endl;
	return ;
}
...
{
	std::cout << target << ", don't breath ten min tic tac" << std::endl;
	return ;
}

void	ScavTrap::eatABug(std::string const & target)
{
	std::cout << target << ", eat a bug boy" << std::endl;
	return ;
}

void	ScavTrap::hitYourSelf(std::string const & target)
{
	std::cout << target << ", hit yourself! Do u like it ha ?" << std::endl;
	return ;
}

void	ScavTrap::tellANotFunnyJoke(std::string const & target)
{
	std::cout << target << ", tell me not funny joke" << std::endl;
	return ;
}
